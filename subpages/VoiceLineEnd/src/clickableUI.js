...
let FINALVOICELINE = new Audio();

pirate.src= "../../music/pirate_music.mp3";
FINALVOICELINE.src = "../../chapters/pirates_final (1).mp3"
...
FINALVOICELINE.addEventListener("timeupdate", function() {
	if (FINALVOICELINE.currentTime >= 73) {
	ending.style.display = "block";
	ending.style.opacity = "1"



	if (FINALVOICELINE.currentTime >= 84) {
		window.location.href = "../../subpages/ending/index.html"
		}
	}
  });
